...
//                         <label htmlFor="first_name" className='w-[100px]text-sm font-medium text-gray-700'>First Name</label>
//                         <input className='mt-3 p-2 w-[200px] rounded-md bg-gray-bkg focus:outline-none ml-[20px]' 
...
//                     </div>
//                     <div className="mb2 mb-[10px]">
//                         <label htmlFor="department" className='w-[100px] text-sm font-medium text-gray-700'>Department</label>
//                         <input className='mt-3 p-2 w-[200px] rounded-md bg-gray-bkg focus:outline-none ml-[20px]'
//                             type="text" placeholder='Department' name="department" value={userDeets.department} onChange={handleInputChange} required
//                         />
//                     </div>
                    
//                     <button type="submit" onClick={handleSubmit} className='btn'>Create User</button>
//                 </form>
//             </div>
//         </div>
//     );
