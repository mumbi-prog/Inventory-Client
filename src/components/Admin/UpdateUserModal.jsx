...
function UpdateUserModal({ onClose, onUpdate, userData }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.email.endsWith('@dakawou.com')) {
        ...
        <form onSubmit={handleSubmit} className="user-details block">
          ...
          <div className="form-group mb-[20px]">
            ...
            <select
              ...
              className="input mt-2 p-2 rounded-md bg-gray-bkg focus:outline-none"
              required
            >
          ...
          <div className="button-container flex justify-center items-center mt-[15px]">
            ...
            <button type='button' onClick={onClose} className="bg-gray-300 text-gray-700 px-4 py-2 rounded-full hover:bg-gray-400">Cancel</button>
          </div>
        </form>
