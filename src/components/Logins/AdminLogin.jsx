...
function AdminLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.post('http://localhost:3000/login', { email, password });
    ...
    <div className='auth-container bg-gray-bkg h-screen flex justify-center items-center'>
      <div className='auth-wrapper ml-[100px] flex w-[1000px]'>
        <div className="login-bkg w-[50%]">
          <h3 className='font-playfair text-6xl font-bold text-white text-center py-[60%]'>Welcome Back</h3>
        </div>
        <div className='form-content bg-white w-[50%] px-[3%]'>
          <h5 className="text-4xl font-bold mt-[20px] mb-[5px] text-black"> Log In </h5>
          <p className="text-black mb-[20px]">Not a member? <Link to="/signup" className='underline text-main-blue font-bold'>Sign up</Link> instead</p>
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-2">
                ...
                <input
                  ...
                  id="email"
                  name="email"
                  className="mt-1 p-2 w-full rounded-md bg-gray-bkg focus:outline-none"
                  required
                  value={email}
              ...
              <div className="auth-button flex justify-center items-center">
                <button className='login uppercase bg-other-blue text-white font-semibold px-4 py-2 rounded-md hover:bg-hover-blue w-full mt-1'>
                  Log In
                </button>
              </div>
